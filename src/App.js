...
function App() {
  ...
  const handleChangeOperator = (input) => {
  ...
  return (
    <div className="App">
      <nav className="navbar navbar-dark bg-dark">
        <a className="navbar-brand" href="http://localhost:3000/"><img width="40px" src="./Lambda-Logo-Red.png" alt="Red School Logo"/> Lambda Reducer Challenge</a>
      </nav>
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton onClick={handleAdd} value={"M+"}/>
